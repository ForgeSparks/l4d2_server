<div class="post">
  <div class="entry">
    ...
    <table class="stats">
      <tr>
        <th rowspan=2>Campaign Name</th><th rowspan=2>Total Playtime</th><th rowspan=2>Total<br />All&nbsp;4&nbsp;Dead</th><th colspan=2>Total Points</th><th colspan=2>Total Kills</th></tr>
      <tr>
        <th>
          <img src="/images/icon_infected.gif" alt="Infected Total Points">
        </th>
        <th>
          <img src="/images/icon_survivors.png" alt="Survivor Total Points">
        </th>
        <th>
          <img src="/images/icon_infected.gif" alt="Infected Total Kills">
        </th>
        <th>
          <img src="/images/icon_survivors.png" alt="Survivor Total Kills">
        </th>
      </tr>
