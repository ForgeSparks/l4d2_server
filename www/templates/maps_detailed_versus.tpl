<table class="stats">
  <tr>
    ...
    <th rowspan=2>Playtime</th>
    <th rowspan=2>All&nbsp;4&nbsp;Dead</th>
    <th colspan=2>Points</th>
    <th colspan=2>Kills</th>
  </tr>
  <tr>
    <th>
      <img src="/images/icon_infected.gif" alt="Infected Points">
    </th>
    <th>
      <img src="/images/icon_survivors.png" alt="Survivor Points">
    </th>
    <th>
      <img src="/images/icon_infected.gif" alt="Infected Kills">
    </th>
    <th>
      <img src="/images/icon_survivors.png" alt="Survivor Kills">
    </th>
  </tr>
  <tr>
    <td>Normal</td>
  ...
  <tr>
    ...
    <td><?php echo $points_infected[2];?></tr>
  ...
  <tr class="alt">
    ...
    <td>
      <b><?php echo $playtime[3];?></b>
    </td>
    <td>
      <b><?php echo $infected_win[3];?></b>
    </td>
    <td>
      <b><?php echo $points_infected[3];?></b>
    </td>
    <td>
      <b><?php echo $points[3];?></b>
    </td>
    <td>
      <b><?php echo $kills[3];?></b>
    </td>
    <td>
      <b><?php echo $survivor_kills[3];?></b>
    </td>
  </tr>
</table>
